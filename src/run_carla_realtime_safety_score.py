#!/usr/bin/env python3
"""
CARLA Real-Time Driver Safety Score Dashboard.
Uses Multi-Model Ensemble (Random Forest v2 + XGBoost v2 + PyTorch 1D-CNN)
with weighted soft-voting probability fusion and a live 0-100 Safety Score engine.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="CARLA Real-Time Driver Safety Score CLI Dashboard")
...
def main():
    ...
    # Initialize Ensemble Detector and Safety Scorer
    ...
    try:
        ...
        print("\nStopping Real-Time Safety Scoring Dashboard...")
    finally:
        imu_sensor.stop()
        imu_sensor.destroy()
